package net.ncguy.utils.loaders;
...
public class G3DXNAModelLoader extends ModelLoader<ModelLoader.ModelParameters> {

    public static final short VERSION_HI = 0;
    public static final short VERSION_LO = 1;
    protected final BaseJsonReader reader;

    public G3DXNAModelLoader (final BaseJsonReader reader) {
        this(reader, null);
    }

    public G3DXNAModelLoader (BaseJsonReader reader, FileHandleResolver resolver) {
        super(resolver);
        this.reader = reader;
    }
    ...
    private void parseMaterials (ModelData model, JsonValue json, String materialDir) {
        ...
        if (materials == null) {
            ...
            for (JsonValue material = materials.child; material != null; material = material.next) {
                ...
                if (textures != null) {
                    AtomicBoolean hasDiffuse = new AtomicBoolean(false);
                    for (JsonValue texture = textures.child; texture != null; texture = texture.next) {
                        ...
                        jsonTexture.usage = parseTextureUsage(textureType, hasDiffuse);
    ...
    private int parseTextureUsage (final String value, AtomicBoolean hasDiffuse) {
